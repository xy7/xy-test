...
public class TxtRecordFactory implements RecordFactory {
	...
	public TxtRecordFactory(String targetName, String idName, Map<String, String> typeMap) {
	 ...
	 * 
	 * @param max
	 *            The number of categories that will be expected. Once this many
	 *            have been
	 ...
	 * As a side effect, features are added into the featureVector. Returns the
	 * value of the target
	 * variable.
	 *
	 * @param line
	 ...
	 *            processLine.
	 * @param returnTarget
	 *            whether process and return target value, -1 will be returned
	 *            if false.
	 * @return The value of the target variable.
	 */
	...
	@Override
	public TxtRecordFactory includeBiasTerm(boolean useBias) {
